...
DATABASE_URL = "file:/Path_to_project/Corpus/bsim_database/corpus"
OUTPUT_FILE_PATH = '/Path_to_project/Sample_binary/raw_rankings'
if not os.path.exists(OUTPUT_FILE_PATH):
    os.makedirs(OUTPUT_FILE_PATH)

MATCHES_PER_FUNC = 500
...
with open(OUTPUT_FILE_PATH + '/' + Library + '.pkl', 'wb') as file_out:
